...
static void jl_init_serializer2(int for_serialize)
{
    ...
    void *tags[] = { ptls->root_task,
                     ...
                     jl_detachnode_type, jl_reattachnode_type, jl_syncnode_type, jl_syncregionnode_type,
                     ...
                     jl_detachnode_type->name, jl_reattachnode_type->name, jl_syncnode_type->name, jl_syncregionnode_type->name,
